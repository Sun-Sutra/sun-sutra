    ...
    >
      <div style={container}>
        ...
        >
            ...
            <div style={{ maxWidth: '440px' }}>
              ...
              <ul style={{ 
                ...
                {[
                  ...
                  'Unpredictable annual power cost inflation',
                  'Complex multi-vendor & regulatory compliance',
                  'Zero sustainability or ESG carbon reduction'
                ].map((text, i) => (
          ...
          {/* FOREGROUND LAYER (The Sun Sutra Way) */}
          <div style={{
            position: 'absolute', 
            inset: 0,
            ...
            <div style={{ position: 'relative', zIndex: 1, maxWidth: '440px' }}>
              ...
              <ul style={{ 
                ...
                {[
                  'Stable, low long-term tariff (₹7 - ₹9/unit)',
